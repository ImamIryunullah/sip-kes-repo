...
export default {
  ...
  mounted() {
    // Periksa status pengguna setelah komponen dimuat
    if (this.$store.state.userStatus !== 'Disetujui') {
      this.$router.push('/home'); // Arahkan ke halaman home jika tidak disetujui
    }
  },
  data() {
    return {
